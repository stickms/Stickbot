...
// Guilds you will allow for server tracking to work
export const SERVER_GUILDS = [];

// Whether the bot should only log local servers or not
export const LOCAL_SERVER_ONLY = false;
